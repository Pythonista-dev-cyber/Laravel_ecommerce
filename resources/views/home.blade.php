...
<div class="container">
    <div class="main-body">
          ...
          $img_path="images/male.png";

          if(Auth::user()->gender=="none"){
            $img_path="images/male.png";
          }
              ...
              <div class="card">
                <div class="card-body">
                  <div class="d-flex flex-column align-items-center text-center">
                    <img src="{{ asset($img_path) }}" alt="Admin" class="rounded-circle" width="150">
                    <div class="mt-3">
  ...
  <div class="card">
    ...
    <div id="collapseOne_{{ $order->id }}" class="collapse" aria-labelledby="headingOne" data-parent="#accordionExample">
      <div class="card-body">
         <ul>
            <li>Order Date : {{ $order->order_date }}</li>
            <li>Order item: {{ $order->order_item }}</li>
            <li>Total: {{ $order->grand_total }}</li>
            <li>Order Status: {{ $order->order_status }}</li>
            <li>Payment Status: <span class="badge bg-black text-whtie"> {{ $order->payment_status }} </span> </li>
            <li> <a href="#" class="btn btn-primary"><i class="fa fa-map"></i> Order Track </a> </li>
         </ul>
      </div>
    </div>
  </div>
