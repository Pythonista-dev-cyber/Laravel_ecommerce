...
<head>
        ...
        <title>Digital Products Store eCommerce</title>
    ...
    @if(Session::has('cart-increase'))
    <script>
        Swal.fire({
        position: "center",
        icon: "success",
        title: "Cart Qty Updated Successfully...",
    ...
    <script>
        ...
        position: "center",
        icon: "success",
        title: "New Item aCreated Successfully...",
        showConfirmButton: false,
        timer: 1500
        });
    </script>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3 col-md-4">
                                <div class="header-top-left">
                                    <ul class="phone-wrap">
                                        <li><span>{{ __('messages.phone') }}:</span><a href="#">(+123) 123 321 345</a></li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-9 col-md-8">
                                <div class="header-top-right">
                                    <ul class="ht-menu">
                                        <!-- Begin Setting Area -->
                                        <li>
                                            <div class="ht-setting-trigger"><span>{{ __('messages.settings') }}</span></div>
                                        ...
                                        <!-- Begin Currency Area -->
                                        <li>
                                            <span class="currency-selector-wrapper">{{ __('messages.currency') }} :</span>
                                        ...
                                        <li>
                                            ...
                                            <div class="language ht-language">
                                                <ul class="ht-setting-list">
                                                    <li class="active">
                                                        <a href="{{route('change.lang', ['lang' => 'en'])}}"><img src="{{asset('frontend/images/menu/flag-icon/1.jpg')}}" alt="">
                                                        English</a>
                                                    </li>
                                                    <li><a href="{{route('change.lang', ['lang' => 'myan'])}}"><img src="{{asset('frontend/images/menu/flag-icon/2.png')}}" alt="">Myan</a></li>
                                                </ul>
                                            </div>
                                        </li>
                                    ...
                                    <ul class="hm-menu">
                                        ...
                                        <li class="hm-minicart">
                                            ...
                                            <div class="minicart">
                                                ...
                                                @endphp
                                                    ...
                                                    <li>
                                                        <a href="#" class="minicart-product-image">
                                                            <img  src="{{asset('images')}}/{{$cart['photo']}}"  alt="cart products" style="width:60px;">
                                                        </a>
                                                ...
                                                <p class="minicart-total">GRAND TOTAL: <span>$ {{$grandtotal}}</span></p>
                                                <div class="minicart-button">
                                                    <a href="{{route('cart.list')}}" class="li-button li-button-fullwidth li-button-dark">
